    ...
    function () {
      function ShippingFormPage(router, alert, spinner) {
        ...
        this.validations = {
          ...
          'weight': [{
            ...
            type: 'pattern',
            message: 'Weight entered is invalid.'
          }, {
            type: 'min',
            message: 'Weight min value not met.'
          }, {
            type: 'max',
            message: 'Weight max value exceeded.'
          }],
          'length': [{
            type: 'required',
            ...
            type: 'pattern',
            message: 'Length entered is invalid.'
          }, {
            type: 'min',
          ...
          'width': [{
            ...
            type: 'pattern',
            message: 'Width entered is invalid.'
          }, {
            type: 'min',
          ...
          'height': [{
            ...
            type: 'pattern',
            message: 'Height entered is invalid.'
          }, {
            type: 'min',
      ...
      _createClass(ShippingFormPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.states = this.countries[0].states; // this.packageTypes = PackageTypes;
          // this.packaging = '';

          this.maxWeight = 150;
          this.maxHeight = 100;
          this.maxLength = 100;
          this.maxWidth = 100; // this.maxHeight = PackageTypes[0].maxHeight;
          ...
          this.packageForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({
            ...
            'weight': new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern('^[0-9]*(\\.\\d{1,2})?$'), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].min(1), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].max(this.maxWeight)])),
            'length': new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern('^[0-9]*$'), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].min(1), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].max(this.maxLength)])),
            'width': new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern('^[0-9]*$'), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].min(1), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].max(this.maxWidth)])),
            'height': new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].pattern('^[0-9]*$'), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].min(1), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].max(this.maxHeight)])),
            'description': new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].minLength(5), _angular_forms__WEBPACK_IMPORTED_MODULE_4__["Validators"].maxLength(100)])),
